...
public class FlowSinkFromXML extends AbstractFlowSink {
	...
	public FlowSinkFromXML(List<Tuple<String, String>> s) {
		this.attribues = s;
	}
	...
	public boolean isReturn() {
		return getAttribut(XMLConstants.ATTRIBUTE_FLOWTYPE)._2.equals(XMLConstants.VALUE_RETURN); 
	}
	...
	public boolean taintSubFields() {
		if(getAttribut(XMLConstants.ATTRIBUTE_TAINT_SUB_FIELDS)._2.equals("false")){
			return false;
		}else{
			return true;
		}
