...
public interface IMethodSummaryProvider {
	...
	/**
	 * Gets the names of all classes for which summaries have not yet been
	 * loaded, but are available on some external storage
	...
	/**
	 * Gets whether the given class is supported by this provider, i.e.,
	 * whether summaries for that class have either already been loaded or can
	 * be loaded
	 * @param clazz The class to check
	 * @return True if the given class is supported b this provider, otherwise
	 * false
	 */
