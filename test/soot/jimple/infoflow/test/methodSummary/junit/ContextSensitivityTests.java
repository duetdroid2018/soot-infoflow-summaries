...
public class ContextSensitivityTests extends TestHelper {
	...
	public void recursionTest1() {
		...
		// Field y to field z
		assertTrue(containsFlow(flow, SourceSinkType.Field, -1, new String[] { FIELD_Y },
				SourceSinkType.Field, -1, new String[] { FIELD_Z } ));
		// Field x to field y
		assertTrue(containsFlow(flow, SourceSinkType.Field, -1, new String[] { FIELD_Y },
				SourceSinkType.Field, -1, new String[] { FIELD_X } ));
		// Transitivity: Field x to field z
		assertTrue(containsFlow(flow, SourceSinkType.Field, -1, new String[] { FIELD_X },
				SourceSinkType.Field, -1, new String[] { FIELD_Z } ));
		
		// On first recursive call: Field y -> str -> Field x (no strong updates on fields)
		assertTrue(containsFlow(flow, SourceSinkType.Field, -1, new String[] { FIELD_Y },
				SourceSinkType.Field, -1, new String[] { FIELD_X } ));
		...
		assertTrue(containsFlow(flow, SourceSinkType.Field, -1, new String[] { FIELD_X }, SourceSinkType.Return, -1, null ));
		assertTrue(containsFlow(flow, SourceSinkType.Field, -1, new String[] { FIELD_Y }, SourceSinkType.Return, -1, null ));
		assertTrue(containsFlow(flow, SourceSinkType.Field, -1, new String[] { FIELD_Z }, SourceSinkType.Return, -1, null ));
