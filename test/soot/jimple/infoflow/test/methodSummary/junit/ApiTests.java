...
public class ApiTests extends ApiTestHelper {
	...
	public void paraToVar2() {
		...
		assertTrue(containsFlow(res, Parameter, 0, null, Field, new String[] {NON_PRIMITIVE_VAR1,DATACLASS_INT_FIELD}));
		assertTrue(containsFlow(res, Parameter, 1, null, Field, new String[] {NON_PRIMITIVE_VAR1,DATACLASS_OBJECT_FIELD}));
	...
	public void swap2() {
		...
		assertTrue(containsFlow(res, Field, new String[] {NON_PRIMITIVE_VAR1,DATACLASS_OBJECT_FIELD},
				Field, new String[] {NON_PRIMITIVE_VAR2,DATACLASS_OBJECT_FIELD}));
		assertTrue(containsFlow(res, Field, new String[] {NON_PRIMITIVE_VAR2,DATACLASS_INT_FIELD},
				Field, new String[] {NON_PRIMITIVE_VAR1,DATACLASS_INT_FIELD}));
	}
	...
	public void fieldToPara1() {
		...
		assertTrue(containsFlow(res, Field, new String[] {NON_PRIMITIVE_VAR1,DATACLASS_INT_FIELD},
				Parameter, 0, new String[] {DATACLASS_INT_FIELD}));
	}
	...
	public void fieldToField3() {
		...
		assertTrue(containsFlow(res, Field, new String[] {NON_PRIMITIVE_VAR2, DATACLASS_INT_FIELD},
				Field, new String[] {PRIMITIVE_VAR}));
	}
	...
	public void storeAliasInGapClass() {
		String mSig = "<" + className + ": java.lang.String storeAliasInGapClass(soot.jimple.infoflow.test.methodSummary.IGapClass,java.lang.String)>";
		Set<MethodFlow> res = createSummaries(mSig).getAllFlows();
	...
	public void setNonPrimitiveData1APL3() {
		...
		assertTrue(containsFlow(res, Parameter, 0, null, 
				Field, -1, new String[] { APICLASS_DATA_FIELD, DATACLASS_OBJECT_FIELD }));
	}
	...
	public void getNonPrimitiveData1APL3() {
		...
		assertTrue(containsFlow(res, Field, -1, new String[] { APICLASS_DATA_FIELD, DATACLASS_OBJECT_FIELD },
				Return, -1, null));
	}
	
	@Test(timeout = 100000)
	public void makeStringUserCodeClass() {
		String mSig = "<" + className + ": java.lang.String makeStringUserCodeClass(soot.jimple.infoflow.test.methodSummary.IUserCodeClass,java.lang.String)>";
		Set<MethodFlow> res = createSummaries(mSig).getAllFlows();
