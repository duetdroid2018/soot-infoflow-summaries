...
public class FieldToParaTests extends TestHelper {
	...
	public void fieldToPara1() {
		...
		//assertTrue(containsFieldToParaFlow(flow,",NO_ACCESS_PATH, 0, DATA,DATACLASS_OBJECT_FIELD));
	...
	public void fieldToPara4() {
		...
		Set<AbstractMethodFlow> flow = s.createMethodSummary(mSig,methods()).getFlowsForMethod(mSig);
		assertTrue(containsFlow(flow, Field,new String[] {DATA_FIELD,DATACLASS_OBJECT_FIELD}, Parameter,0,new String[] {DATACLASS_OBJECT_FIELD}));
